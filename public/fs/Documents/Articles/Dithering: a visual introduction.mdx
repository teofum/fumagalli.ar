...
{/_ <ImageGrid pixelated noScroll images={[
{
src: '/content/articles/dither/tram-original',
formats: ['webp', 'jpeg'],
alt: 'Original image',
...
{/_ <ImageGrid minSize='30ch' pixelated images={[
{
...
{/_ <DemoOrdered type='bayer' sizes={{
  '2': '2 × 2',
  '4': '4 × 4',
  '8': '8 × 8'
}} /> _/}
...
{/_ <DemoOrdered type='blueNoise' sizes={{
  '16': '16 × 16',
  '64': '64 × 64'
}} initial='64' /> _/}
...
{/_ <DemoOrdered type='halftone' sizes={{
  '4': '4 × 4',
  '6': '6 × 6',
  '8': '8 × 8'
}} /> _/}
