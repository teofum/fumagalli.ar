...
void main() {
  ...
  float t = texture2D(u_threshold, thresholdCoord).x;
  float r = color.x < (t + 1.0 / (u_thres_size * u_thres_size * 2.0)) ? 0.0 : 1.0;
  float g = color.y < (t + 1.0 / (u_thres_size * u_thres_size * 2.0)) ? 0.0 : 1.0;
  float b = color.z < (t + 1.0 / (u_thres_size * u_thres_size * 2.0)) ? 0.0 : 1.0;
