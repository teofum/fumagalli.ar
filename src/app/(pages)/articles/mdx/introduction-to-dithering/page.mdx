...
export const metadata = {
  title: 'A visual introduction to dithering — Teo Fumagalli',
  description:
    'This article explains how dithering works and some of the different approaches to dithering, with interactive visual elements.',
};
