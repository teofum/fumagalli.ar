...
import PaintToolbox from './ui/paint-toolbox';
import { type PaintState, defaultPaintState } from './types';
import { PaintProvider } from './context';
import PaintColor from './ui/paint-color';
import useDesktopStore from '@/stores/desktop';
import PaintFileMenu from './ui/paint-file-menu';
import PaintEditMenu from './ui/paint-edit-menu';
import PaintImageMenu from './ui/paint-image-menu';
import PaintViewMenu from './ui/paint-view-menu';
import ContextMenu from '@/components/ui/ContextMenu';
import PaintContextMenu from './ui/paint-context-menu';
