...
import type { Card as CardType, SolitaireSettings } from './types';
...
import { solitaire_deck } from './modals/deck-select';
    ...
    <div className="flex flex-col gap-0.5">
        ...
        <Menu.Menu trigger={<Menu.Trigger>Game</Menu.Trigger>}>
          ...
          <Menu.Sub label="Rules">
            <Menu.RadioGroup
              ...
              onValueChange={(value) =>
                set({ ...settings, rules: value as SolitaireSettings['rules'] })
              }
            >
          ...
          <Menu.Sub label="Scoring">
            <Menu.RadioGroup
              ...
              onValueChange={(value) =>
                set({
                  ...settings,
                  scoring: value as SolitaireSettings['scoring'],
                })
              }
            >
      ...
      >
        ...
        >
          ...
          {/* Drawn cards */}
          <div className="relative w-17.75 h-24">
          ...
          {[0, 1, 2, 3].map((iStack) => (
            ...
            >
              ...
              {game.stacks[iStack].map((card, iCard) => {
          ...
          {[0, 1, 2, 3, 4, 5, 6].map((iRow) => (
            <div
              key={`row_${iRow}`}
              id={`stack-row-${iRow}`}
              className="relative w-17.75 h-24"
            >
